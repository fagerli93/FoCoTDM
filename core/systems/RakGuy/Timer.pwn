...
stock CreateText()
{
	format(TDTimer_TimerStr, sizeof(TDTimer_TimerStr), "Nothing : ~r~00:00");
...
{
    format(TDTimer_TimerStr, sizeof(TDTimer_TimerStr),"%s : ~r~%02d:%02d", Timer_TimerStr, EDIT_Mins, EDIT_Secs);
