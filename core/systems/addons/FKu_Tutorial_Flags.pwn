...
new const explain[][] = { //fixed version
        ...
        "{ffffff}There are vehicles scattered all over LS and there are a few in the other cities, feel free to take them for a spin.",// Airport
        ...
        "{ffffff}Now off you go to kill some noobs! \nDont forget to type {ffea00}/class{ffffff} when you spawn to set and get your weapons!"//bridge
};
