...
new const eventSlots[19] = {-1, -1, 16, -1, 11, -1, 28, 42, 18, 31, 32, 32, 58, 15, 15, 15, 15, 15, 10}; /* -1 = unlimited slots */
...
public event_OnPlayerDeath(playerid, killerid, reason)
{
	...
	if(Event_ID != -1)
	{
		...
		{		
			...
			if((Event_ID == JEFFTDM || Event_ID == AREA51 || Event_ID == ARMYVSTERRORISTS || Event_ID == NAVYVSTERRORISTS || Event_ID == COMPOUND || Event_ID == OILRIG || Event_ID == DRUGRUN || Event_ID == PURSUIT) && killerid != INVALID_PLAYER_ID)
			{
