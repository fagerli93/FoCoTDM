...
public drugrun_EventStart(playerid)
{
	...
	for(new i; i < 16; i++)
	{
		new eCarID = CreateVehicle(DrugRunVehicles[i][modelID], DrugRunVehicles[i][X], DrugRunVehicles[i][Y], DrugRunVehicles[i][Z], DrugRunVehicles[i][Rotation], 1, 1, 600000);
